...
const PublicationsAdmin = () => {
  ...
  const handleSubmit = async (values: Omit<Publication, "_id">) => {
    ...
    try {
      ...
      if (result.success) {
        message.success(
          `Publication ${editingId ? "updated" : "created"} successfully`
        );
  ...
  return (
    <div style={{ padding: "24px" }}>
      ...
      <Modal
        ...
        contentLabel={editingId ? "Edit Publication" : "Add Publication"}
      >
        <div
          style={{
            display: "flex",
        ...
        <Form
          ...
          initialValues={{ citations: 0, order: 0 }}
        >
          <Form.Item
            label="Title"
            name="title"
          ...
          <Form.Item
            label="Journal"
            name="journal"
            rules={[{ required: true, message: "Please enter journal" }]}
          >
          ...
          <Form.Item
            label="DOI"
            name="doi"
            rules={[{ required: true, message: "Please enter DOI" }]}
          >
            <Input placeholder="e.g., 10.1007/s00285-024-01234-5" />
          </Form.Item>
